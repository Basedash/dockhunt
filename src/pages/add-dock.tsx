  ...
  return (
    <>
      ...
      <div className="flex min-h-screen max-w-[800px] flex-col items-start justify-center px-4">
        ...
        <p className={"mb-8 text-xl"}>The command will:</p>
        <ol className="mt-2 mb-8 list-decimal pl-8 text-xl">
          <li>Find the apps in your dock</li>
          <li>Upload any icons not yet in our database</li>
          <li>Create a dock on this website</li>
        </ol>
        <p className={"mb-8 text-xl"}>
          Dockhunt will only use the apps that are pinned to your dock. Those
          are the apps you marked as "Stay in dock" when you right-clicked on
          them and selected "Options". The apps that are not pinned will be
          ignored.
        </p>
        <Image
          className={"mb-8"}
